/* RadarMapa RJ — Etapa 2
 * Nesta etapa: geolocalização, busca de destino, cálculo de rota via OSRM
 * e resumo da rota com contagem preliminar de radares próximos.
 */
...
function setUserMarker(location) {
  ...
  AppState.userMarker = L.marker(location, {
    icon: L.divIcon({
      ...
      html: '<div class="location-marker"><i class="fa-solid fa-location-crosshairs"></i></div>',
      iconSize: [34, 34],
      iconAnchor: [17, 17],
      popupAnchor: [0, -18],
    }),
...
/* Aproximação geoespacial simples.
 * Para a Etapa 3, poderemos trocar por Turf.js e pointToLineDistance.
 */
